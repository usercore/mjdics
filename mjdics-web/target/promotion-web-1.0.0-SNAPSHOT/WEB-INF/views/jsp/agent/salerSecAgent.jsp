	...
	$(function() {
		$('#tt').datagrid({
			...
			onBeforeLoad:function(param){
				type = '${type}';
				$(this).datagrid('options').url = '${siteContext}/admin/agent/selectSalerBySecAgent?type='+type;
...
<body>
		...
		<div style="margin-bottom: 5px">
				<c:if test="${(sessionScope.agent.type=='ADMIN'&&type=='FIRST_BUSS')||sessionScope.agent.type=='SEC_BUSS'}">
						...
						<table width="100%" style="table-layout: fixed;">
							<tbody>
								<tr>
									...
									<td width="80px" align="right">业务员ID：</td>
									<td width="270px"><input id="agentId" type="text" name="agentId" value=""
										class="inputxt" datatype="s4-10" nullmsg="请输入业务员Id" 
						...
						<table width="100%" style="table-layout: fixed;">
							<tbody>
								<tr>
									...
									<td width="80px" align="right">业务员ID：</td>
									<td width="270px"><input id="agentId" type="text" name="agentId" value=""
										class="inputxt" datatype="s4-10" nullmsg="请输入业务员Id"  onchange="isExistAgent(this);"
										errormsg="格式为4-10位字符" /></td>
									<td><div class="Validform_checktip"></div></td>
								</tr>
								<tr>
