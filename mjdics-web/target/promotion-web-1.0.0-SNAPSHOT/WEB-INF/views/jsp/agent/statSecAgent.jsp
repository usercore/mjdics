...
var agentTyeps = new Array();
	...
	$(function() {
		$('#tt').datagrid({
			...
			{field:'id',title:'推广记录',width:50,align:'center',
				formatter:function(value,row,index){
					return '<a href="${siteContext}/admin/agentTrade/gotoPromotionList?agentId='+row.agentId+'">推广记录</a>';
				}
			}] ],
			...
			onBeforeLoad:function(param){
					$(this).datagrid('options').url = '${siteContext}/admin/agent/statSecAgent';
			}
		});
	});
</script>
