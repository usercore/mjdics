		...
		$('#tt').datagrid({
			...
			columns : [ [ {
				...
				formatter : function(value) {
					<c:forEach var="agentTradeTyep" items="${agentTradeTypeEnum}" varStatus="i"> 
						if ('${agentTradeTyep}' == value)
							return '${agentTradeTyep.name}'; 
					</c:forEach>
				}
			},{
				field : 'addTime',
			...
			onBeforeLoad:function(param){
				$(this).datagrid('options').url = '${siteContext}/admin/agentTrade/promotionList?agentId=${agentId}';
			}
		});
	});
