...
document.getElementById('popIframe').style.display='none';
	...
	$(function() {
		$('#tt').datagrid({
			...
			},{field:'status',title:'转账',width:50,align:'center',
				formatter:function(value,row,index){
					if(value=='APPLY')
					return '<a href="javascript:transferMoney()">转账</a>';
				}
			}] ],
			...
			onBeforeLoad:function(param){
				//type = '${type}';
				$(this).datagrid('options').url = '${siteContext}/admin/applyCash/selectApplyCash';
			}
		});
	});
