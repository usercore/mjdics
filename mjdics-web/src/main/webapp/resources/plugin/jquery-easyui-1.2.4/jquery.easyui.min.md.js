...
_87.onClick.call(_86,_105(_86));
	...
	if($(this).hasClass("tree-isfolder")){
		$(this).addClass("tree-folder-hover");
	}else{
		$(this).addClass("tree-file-hover");
	}
return false;
}).bind("mouseleave.tree",function(){
	if($(this).hasClass("tree-isfolder")){
		$(this).removeClass("tree-folder-hover");
	}else{
		$(this).removeClass("tree-file-hover");
	}
return false;
...
if(_cc.children&&_cc.children.length){
	_cd.addClass("tree-isfolder")
}else{
	_cd.addClass("tree-isfile")
}
$.data(_cd[0],"tree-node",{id:_cc.id,text:_cc.text,iconCls:_cc.iconCls,attributes:_cc.attributes});

if(_cc.children&&_cc.children.length){
$("<span class=\"tree-title tree-text-folder\"></span>").html(_cc.text).appendTo(_cd);
}else{
$("<span class=\"tree-title tree-text-file\"></span>").html(_cc.text).appendTo(_cd);
}
if(_c4.checkbox){
...
function _105(_106){
var node=$(_106).find("div.tree-folder-selected");
if(node.length){
return _af(_106,node[0]);
}else{
node=$(_106).find("div.tree-file-selected");
if(node.length){
return _af(_106,node[0]);
}else{
return null;
...
$("div.tree-folder-selected",_121).removeClass("tree-folder-selected");
$("div.tree-file-selected",_121).removeClass("tree-file-selected");
	if($(_122).hasClass("tree-isfolder")){
		$(_122).addClass("tree-folder-selected");
	}else{
		$(_122).addClass("tree-file-selected");
	}
...
return jq.each(function(){
var tree=$.data(this,"combotree").tree;
tree.find("div.tree-folder-selected").removeClass("tree-folder-selected");
tree.find("div.tree-file-selected").removeClass("tree-file-selected");
$(this).combo("clear");
});
}};
