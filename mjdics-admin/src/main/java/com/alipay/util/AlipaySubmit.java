...
import com.magic.util.AlipayProperties;
...
public class AlipaySubmit {
     ...
     */
    private static final String ALIPAY_GATEWAY_NEW = AlipayProperties.payGateway;
    /**
     * 生成签名结果
     * @param sPara 要签名的数组
     * @return 签名结果字符串
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        //sbHtml.append("<%@ page contentType=\"text/html; charset=UTF-8\"%>");
